...
- Of the small slice that classifies as *Coffea* specifically, direct read-level inspection shows it's low-specificity repeat sequence and ambiguous multi-mapping regions, not genuine missed signal.
